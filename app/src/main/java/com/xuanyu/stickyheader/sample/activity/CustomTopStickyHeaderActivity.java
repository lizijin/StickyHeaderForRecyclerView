...
import com.xuanyu.stickyheader.sample.stickymodel.CustomBookStickyHeaderModel;

import java.util.ArrayList;
import java.util.List;

public class CustomTopStickyHeaderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StickyHeaderRegistry.registerTransfer(CustomBook.class, CustomBookStickyHeaderModel.class);
    ...
    private List<Naming> getCharacters(int arrayId, String bookName) {
        ...
        namings.add(new CustomBook(bookName));
